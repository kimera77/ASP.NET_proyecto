  ...
  template: `
    ...
    <aside [class.translate-x-0]="isOpen" 
      ...
      <div class="p-6 border-b border-green-700/50">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-emerald-300/80">Panel de Gestión</p>
          </div>
        </div>
      </div>
      ...
      <nav class="flex-1 p-4 space-y-1">
        ...
        <p class="text-xs font-semibold text-emerald-400/60 uppercase tracking-wider px-3 mt-6 mb-3">Gestión</p>
